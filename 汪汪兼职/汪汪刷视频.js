 ...
 * 
 * ========= 青龙 =========
 * 变量格式：export wwsspapp=' xxxx & xxx @  xxxx & xxx '  多个账号用 @分割 
 * 
 */

 const jsname = "汪汪兼职刷视频";
 const $ = Env(jsname);
 const notify = $.isNode() ? require('./sendNotify') : '';      // 这里是 node（青龙属于node环境）通知相关的
 const Notify = 1; //0为关闭通知，1为打开通知,默认为1
 const debug = 1; //0为关闭调试，1为打开调试,默认为0
 //////////////////////
 let wwsspapp = process.env.wwsspapp;               // 这里是 从青龙的 配置文件 读取你写的变量
 let wwsspappArr = [];
 let data = '';
 let msg = '';
...
function 刷视频42金币(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://video.hnmzq.com/api/shortVideoRecordController.do?saveRecord`,
			headers: {
				"taskid": "e360d085c3434b9f08c32edd593fd02f72342a791f47ee903388d09b6bffb42e74342e2cd6fee70c5ae78f8c4e98792903fb62ed091dace0",
				"version_mtzd": "101",
			...
			body: `userid=${data}&version_mtzd=101&currentOaid=&patchversion=1000&channelid=hbsp_ali&originchannel=mtzd`,
		}
		$.post(url, async (err, resp, data) => {
			try {
				...
				if (result.success == true) {
					...
					console.log(`【刷视频42金币】：${result.msg} 🎉获得:${result.obj.gold}金币 \n`)
				} else {

					console.log(`【刷视频42金币】：${result.msg} 🎉`)
...
function 刷视频48金币(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://video.hnmzq.com/api/shortVideoRecordController.do?saveRecord`,
			headers: {
				"taskid": "e360d085c3434b9f08c32edd593fd02f72342a791f47ee903388d09b6bffb42e5c0a0b4af9ca998931faf7ea6c7f3d80b1d36e0337065fdb",
				"version_mtzd": "101",
				"Content-Type": "application/x-www-form-urlencoded",
				"Content-Length": "125",
				"Host": "video.hnmzq.com",
		...
		$.post(url, async (err, resp, data) => {
			try {
				...
				if (result.success == true) {
					...
					console.log(`【刷视频48金币】：${result.msg} 🎉获得:${result.obj.gold}金币 \n`)
				} else {

					console.log(`【刷视频48金币】：${result.msg} 🎉`)
...
function 刷视频80金币(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://video.hnmzq.com/api/shortVideoRecordController.do?saveRecord`,
			headers: {
				"taskid": "e360d085c3434b9f08c32edd593fd02f72342a791f47ee903388d09b6bffb42e5c0a0b4af9ca99890a63a8359f77a5c1460eae5d5dbb9e99",
				"version_mtzd": "101",
				"Content-Type": "application/x-www-form-urlencoded",
				"Content-Length": "125",
				"Host": "video.hnmzq.com",
		...
		$.post(url, async (err, resp, data) => {
			try {
				...
				if (result.success == true) {
					...
					console.log(`【刷视频80金币】：${result.msg} 🎉获得:${result.obj.gold}金币 \n`)
				} else {

					console.log(`【刷视频80金币】：${result.msg} 🎉`)
...
function 刷视频36金币(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://video.hnmzq.com/api/shortVideoRecordController.do?saveRecord`,
			headers: {
				"taskid": "e360d085c3434b9f08c32edd593fd02f72342a791f47ee903388d09b6bffb42e5c0a0b4af9ca998941d12780c99951c285f02fd07035033e",
				"version_mtzd": "101",
				"Content-Type": "application/x-www-form-urlencoded",
				"Content-Length": "125",
				"Host": "video.hnmzq.com",
		...
		$.post(url, async (err, resp, data) => {
			try {
				...
				if (result.success == true) {
					...
					console.log(`【刷视频36金币】：${result.msg} 🎉获得:${result.obj.gold}金币 \n`)
				} else {

					console.log(`【刷视频36金币】：${result.msg} 🎉`)
...
function 刷视频30金币(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://video.hnmzq.com/api/shortVideoRecordController.do?saveRecord`,
			headers: {
				"taskid": "e360d085c3434b9f08c32edd593fd02f72342a791f47ee903388d09b6bffb42e5c0a0b4af9ca99895040bea86bcf6afeaefc261afb5207ab",
				"version_mtzd": "101",
				"Content-Type": "application/x-www-form-urlencoded",
				"Content-Length": "125",
				"Host": "video.hnmzq.com",
		...
		$.post(url, async (err, resp, data) => {
			try {
				...
				if (result.success == true) {
					...
					console.log(`【刷视频30金币】：${result.msg} 🎉获得:${result.obj.gold}金币 \n`)
				} else {

					console.log(`【刷视频30金币】：${result.msg} 🎉`)
...
function 刷视频32金币(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://video.hnmzq.com/api/shortVideoRecordController.do?saveRecord`,
			headers: {
				"taskid": "e360d085c3434b9f08c32edd593fd02f72342a791f47ee903388d09b6bffb42e5c0a0b4af9ca9989666f48b7b9f82dfed6a236b12b7a18f9",
				"version_mtzd": "101",
				"Content-Type": "application/x-www-form-urlencoded",
				"Content-Length": "125",
				"Host": "video.hnmzq.com",
		...
		$.post(url, async (err, resp, data) => {
			try {
				...
				if (result.success == true) {
					...
					console.log(`【刷视频32金币】：${result.msg} 🎉获得:${result.obj.gold}金币 \n`)
				} else {

					console.log(`【刷视频32金币】：${result.msg} 🎉`)
...
function 刷视频34金币(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://video.hnmzq.com/api/shortVideoRecordController.do?saveRecord`,
			headers: {
				"taskid": "e360d085c3434b9f08c32edd593fd02f72342a791f47ee903388d09b6bffb42e5c0a0b4af9ca99898c94548a8a3e25b86d882dcb2e5b7c0c",
				"version_mtzd": "101",
				"Content-Type": "application/x-www-form-urlencoded",
				"Content-Length": "125",
				"Host": "video.hnmzq.com",
		...
		$.post(url, async (err, resp, data) => {
			try {
				...
				if (result.success == true) {
					...
					console.log(`【刷视频34金币】：${result.msg} 🎉获得:${result.obj.gold}金币 \n`)
				} else {

					console.log(`【刷视频34金币】：${result.msg} 🎉`)
...
function 观看视频领红包(timeout = 0) {
 ...
 async function Envs() {
	 if (wwsspapp) {
		 if (wwsspapp.indexOf("@") != -1) {
			 wwsspapp.split("@").forEach((item) => {
				 wwsspappArr.push(item);
			 });
		 } else {
			 wwsspappArr.push(wwsspapp);
		 }
	 } else {
		 console.log(`\n 【${$.name}】：未填写变量 wwsspapp`)
		 return;
