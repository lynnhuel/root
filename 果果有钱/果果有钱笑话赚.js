 ...
 !(async () => {
	 ...
	 if (!(await Envs()))  	//多账号分割 判断变量是否为空  初步处理多账号
		 ...
		 for (let index = 0; index < ggyqappArr.length; index++) {
			 ...
			 for(i=0;i<26;i++){
				 sleep =randomInt(15,19);    //这个是随机延时多少秒
				 await 获取笑话();
				 console.log('延迟'+sleep+'秒领取奖励');
...
function 获取笑话(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://rbb.hotbuybuy.com/wangzhuan/earns/api/joke/pull`,
			headers: {
				"Connection": "close",
				"appid": "xianyu",
				"appCode": "6",
				...
				"userid": data[1],
				"time": "1659604387776",
				"nsSecret1": "5210b6ab819bfabe42958c4c62c3c680",
				"os_version": "27",
				"isEmulator": "0",
...
function 领取笑话奖励(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://rbb.hotbuybuy.com/wangzhuan/earns/api/joke/push`,
			headers: {
				"Connection": "close",
				"appid": "xianyu",
				"appCode": "6",
				...
				"userid": data[1],
				"time": "1659604404754",
				"nsSecret1": "53daca9aac11b8efeff1c92c75698e4e",
				"os_version": "27",
				"isEmulator": "0",
				"Content-Type": "application/x-www-form-urlencoded",
				"Content-Length": "16",
