...
function 转盘100次(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://b3noz2ckcgokcgok.hotbuybuy.com/luckdraw/luck`,
			headers: {
				"Connection": "close",
				"appid": "xianyu",
				"appCode": "6",
				...
				"userid": data[1],
				"time": "1659678801469",
				"nsSecret1": "07e35b3e6d53d0466bf9f188f1b318e4",
				"os_version": "27",
				"isEmulator": "0",
				"Content-Length": "0",
...
function 获取转盘id(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://b3noz2ckcgokcgok.hotbuybuy.com/luckdraw/stage/list`,
			headers: {
				"Connection": "close",
				"appid": "xianyu",
				"appCode": "6",
				...
				"userid": data[1],
				"time": "1659678802609",
				"nsSecret1": "a6235cde966eb3e217f1426bc72bb53c",
				"os_version": "27",
				"isEmulator": "0",
				"Content-Length": "0",
				"Host": "b3noz2ckcgokcgok.hotbuybuy.com",
