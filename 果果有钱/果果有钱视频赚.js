...
function 获取视频(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://rbb.hotbuybuy.com/wangzhuan/advertisement/api/video/buss`,
			headers: {
				"Connection": "close",
				"appid": "xianyu",
				"appCode": "6",
				...
				"userid": data[1],
				"time": "1659840216260",
				"nsSecret1": "17fc737d086c29905b8341989d103bb8",
				"os_version": "27",
				"isEmulator": "0",
				"Content-Length": "0",
		...
		$.post(url, async (err, resp, data) => {
			try {
				...
				if (result.success == true) {
					...
					console.log(`【获取视频】：${result.message} 🎉\nid为:${result.data.id}`)
                    id=result.data.id
				} else {

					console.log(`【获取视频】获得：${result.message} 🎉\n`)
