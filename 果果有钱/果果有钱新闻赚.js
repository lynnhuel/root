...
function 获取新闻(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://rbb.hotbuybuy.com/wangzhuan/earns/api/news/begin`,
			headers: {
				"Connection": "close",
				"appid": "xianyu",
				"appCode": "6",
				...
				"userid": data[1],
				"time": "1659621506241",
				"nsSecret1": "22fd740ac74d7bfa9f1a377973ff63db",
				"os_version": "27",
				"isEmulator": "0",
...
function 领取新闻奖励(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://rbb.hotbuybuy.com/wangzhuan/earns/api/news/end`,
			headers: {
				"Connection": "close",
				"appid": "xianyu",
				"appCode": "6",
				...
				"userid": data[1],
				"time": "1659621527989",
				"nsSecret1": "ac33959111983a6ef0b74cfbedb8ed70",
				"os_version": "27",
				"isEmulator": "0",
				"Content-Type": "application/x-www-form-urlencoded",
				"Content-Length": "35",
		...
		$.post(url, async (err, resp, data) => {
			try {
				...
				if (result.success == true) {
					...
					console.log(`【领取新闻奖励】：${result.message} 🎉获得:${result.data.point}金币`)
				} else {

					console.log(`【领取新闻奖励】：${result.message} 🎉`)
