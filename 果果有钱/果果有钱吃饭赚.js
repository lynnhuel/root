...
function 查询id(timeout = 0) {
	return new Promise((resolve) => {

		let url = {
			url: `http://rbb.hotbuybuy.com/wangzhuan/earns/api/eat/list`,
			headers: {
				"Connection": "close",
				"appid": "xianyu",
				"appCode": "6",
				...
				"userid": data[1],
				"time": "1659837820165",
				"nsSecret1": "662792e7e01caf5ba38c2b7ae064e06f",
				"os_version": "27",
				"isEmulator": "0",
				"Content-Length": "0",
		...
		$.post(url, async (err, resp, data) => {
			try {
				...
				if (result.success == true) {
					...
					console.log(`【查询id】获得：${result.message} 🎉\n`)
...
function 领取吃饭奖励(num) {
	return new Promise((resolve) => {
		...
		let url = {
			url: `http://rbb.hotbuybuy.com/wangzhuan/earns/api/eat/reward`,
			headers: {
				"Connection": "close",
				"appid": "xianyu",
				"appCode": "6",
				...
				"userid": data[1],
				"time": "1659838010656",
				"nsSecret1": "fd01f3dacc421fb641403458a3aa9620",
				"os_version": "27",
				"isEmulator": "0",
				"Content-Length": "0",
				"Host": "b3noz2ckcgokcgok.hotbuybuy.com",
		...
		$.post(url, async (err, resp, data) => {
			try {
				...
				if (result.success == true) {
					...
					console.log(`【领取吃饭奖励】：${result.message} 🎉获得:${result.data}金币`);

				} else {

					console.log(`【领取吃饭奖励】：${result.message} 🎉`)
